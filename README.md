...
>
> 📦 **[Компоненты и стилизация экрана настроек (M3_KIT.md)](M3_KIT.md)**
> Готовый UI-набор Material Design 3 (Material You) для верстки экранов настроек обоев (слайдеры, переключатели, карточки, динамическая палитра).
>
